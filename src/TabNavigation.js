        ...
        screenOptions={({ route }) => ({
          ...
          tabBarIcon: ({ focused}) => {
            ...
            if (route.name === 'Контент') {
              iconName = focused ? require('../src/image/icon-star-active.png') : require('../src/image/icon-star.png');
            ...
            //   iconName = focused ? require('../src/image/icon-bell-active.png') : require('../src/image/icon-bell.png');
            //   iconStyle = styles.icon;
            //   textStyle = focused ? styles.textActive : styles.text
            ...
            <View style={styles.wrapper}>
              ...
              <AppTextSemiBold style={textStyle}>{tabName = route.name}</AppTextSemiBold>
            </View>
            );
          },
        })}
